    ...
    while true; do
        ...
        if read -r -t $timeout_interval -n 1 -s input 2>/dev/null || read -r -t 0.1 -n 1 input 2>/dev/null; then
            case "$input" in
                ...
                r|R)
                    update_monitor_data
                    show_fixed_prompt  # 手动刷新后重新显示底部提示
                    ;;
                c|C)
                    set_custom_refresh_interval
                    ;;
...
update_monitor_data() {
    ...
    echo -e "\033[3;63H\033[1;37m$uptime\033[0m"
...
update_system_info() {
    ...
    echo -e "\033[7;2H\033[1;32m│\033[1;37m  🔧 架构: $arch    🌍 内网IP: $internal_ip \033[1;33m                      \033[1;32m│\033[0m"
    echo -e "\033[8;2H\033[1;32m│\033[1;37m  🌐 公网IP: $external_ip \033[1;33m                        \033[1;32m│\033[0m"
    echo -e "\033[9;2H\033[1;32m└────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘\033[0m"
}
...
update_cpu_info() {
    ...
    echo -e "\033[11;2H\033[1;32m┌────────────────────────────────────────────────────────────────────────────────────────────────────────────────┐\033[0m"
    echo -e "\033[12;2H\033[1;32m│\033[1;37m  🖥️  CPU监控 ($cores核心) - 使用率: ${cpu_usage}%     🌡️  温度: $temp     \033[1;32m│\033[0m"
    echo -e "\033[13;2H\033[1;32m│\033[1;37m  📋 型号: $cpu_model\033[1;32m│\033[0m"
    echo -e "\033[14;2H\033[1;32m│\033[1;37m  ⚡ 频率: $min_freq - $max_freq  🚀 负载: $load  \033[1;32m│\033[0m"
    # 清理该行并重新显示
    echo -e "\033[15;2H\033[K\033[1;32m│\033[1;37m  💻 核心负载: [$core_usage] \033[1;32m│\033[0m"
